---
description: >-
  A collection of new and classic outfits available through the MoonBD account
  shop.  Includes both Pearl Shop and Cash Shop sets for all classes, along with
...
These are **ship overlays** designed specifically for Carracks.
...
* **Grandpa Cron’s Helper & Lil’ Helper** Sets
* **Pumpkin Witch / Tailor** Collections
* **Mr. Mussels** Series
* **Yeoreum**, **Primavera**, and **Roselyn** Seasonal Sets
* **Taebaek**, **Superius**, and **Salanar** Sets
* **Secrua**, **Ossa Cerberi**, **Lath’rakan**, and **Parthenoa** Series
* **Duskherald**, **Goldscale Dragoon**, and **Twilight Prowler** Collections
* **Sapphire Storm**, **Harakhty**, **Keraunos**, and **Hemomancer** Premium Sets
* **Rose Noire** and **Darkborne Rose** Collections
* **Nightveil**, **Blood Countess**, and **Gotha Rensa** Sets
* **Autumna Brilliance** and **Elderwood** Collections
* **Umbra Clan**, **Rakshasa**, and **Ulfhedinn** Sets
* **Gigataurus**, **Doomsday**, and **Duskherald** Premium Series

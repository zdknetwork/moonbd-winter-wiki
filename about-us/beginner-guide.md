---
description: >-
  Quick-start guide for new MoonBD players. Covers account setup, starter gear,
  voting, Pit of Undying, and best-in-slot gear progression.
---
...
To initialize characters and claim starting items:

* **Account Initialization**: Completing only the first few main quests initializes the account. Attempting the full main questline is unnecessary.
* **Black Spirit Quests**: Pressing `/` opens the **Black Spirit** interface to accept all custom **\[MoonBD]** quests.
* **Starter Boxes**: Opening the starter boxes placed in the character inventory upon creation yields starting items.
* **Challenge Rewards**: Pressing `Y` opens the Challenge Menu to claim login and progression rewards.

#### Coupon Codes

Permanent rewards and supplies can be claimed via the website:

* Players should join the official [MoonBD Discord](https://discord.gg/3xK6p7rhD4) server and check the `#codes` channel for the latest codes.
* Codes are entered on the [Redeem Page](https://moonbd.online/redeem).

#### Daily Server Voting

Voting daily on the official website awards **Mysterious Tokens**:

* **Daily Reward**: Two **Mysterious Tokens** are awarded each day for voting on the [Vote Page](https://moonbd.online/vote).
* **Mysterious Shop**: Tokens can be exchanged for premium rewards on the [Mysterious Shop](https://moonbd.online/account/mysterious-shop) page:
  * **MoonBD Premium (3 Days)**: 30 **Mysterious Tokens**
  * **Ornette's Spirit Essence**: 40 **Mysterious Tokens**
  * **Odore's Spirit Essence**: 40 **Mysterious Tokens**
  * **Advice of Valks (+1000 to +3000)**: 50 to 90 **Mysterious Tokens**
  * **Tier-4 Pets & Boss Boxes** (e.g., **Hedgehog**, **Golden Dragon**): 75 **Mysterious Tokens**

#### Starting Benchmarks & Quality of Life

The following resources and benefits are active immediately after completing the starter quest:

* **672+ Gear Score**: Provides immediate combat readiness. Combined with starting buffs, characters are fully geared to solo lucrative **Elvia** zones such as **Orc Camp** or **Bloody Monastery**.
* **Instant Unlocks**: **Awakening**, **Succession**, and all permanent **Adventure Log** stats (AP, DP, HP) are active from the beginning.
* **Full Map Reveal**: The entire world map is fully visible, eliminating the need for manual exploration.
* **200 Energy & 200 Contribution**: Contribution points can be invested into nodes surrounding **Heidel** or **Calpheon** to establish worker nodes. The Energy pool is used for node-leveling or stored as potions via NPC **Alustin**.
* **30,000 Pearls & 10,000 Loyalties**: The starting Pearl shop budget enables the purchase of **Storage Maids**, **Marketplace Maids**, inventory expansions, and weight limit increases.
* **90,000,000 Silver**: Base starting currency.
* **9 Tier-4 Pets**: Setting the top five pets to agile behavior handles rapid-fire looting during high-end **Elvia** grinding.
* **3-Day Infinite Potion Buff**: Characters begin with three days of automatic healing. This serves as the primary grinding window to gather materials for permanent **Exalted Potions**.

#### Grind Enabler (Shiny Insignia)
...
Daily matches in the **Pit of Undying** arena must be completed to collect **Crow's Black Jewels** for insignia upgrades. Missing daily matches delays the acquisition of passive combat stats.
...
**PEN (V) Undying Crow's Insignia Stats**

Equipped in the Adventurer's Tome slot, the **PEN (V) Undying Crow's Insignia** provides two crystal sockets (recommended for **Hoom** crystals) and grants the following stats:

* **Base Stats**: AP 10 - 10, Accuracy 29, DP 10 (Damage Reduction 10)
* **Item Effects**: Max HP +1000, Damage Reduction Against Monsters +50, AP Against Monsters +100, Max Stamina +450, All Evasion +8

#### Infinite Potions

Infinite potions provide a non-consumable, permanent source of recovery. Grinding extra stones or exchanging materials is unnecessary. Collecting the three base materials allows NPC **Merindora** in **Grana** to award the completed base potion.
...
**Kharazad Accessories** represent the primary pathway for accessory progression. They are not destroyed upon a failed enhancement attempt; instead, only their maximum durability decreases.
...
* **Deboreka** accessories and **Magical Shards** are obtainable via the **Central Market** or by grinding.
* **Essence of Dawn** is obtained by heating yellow grade `TET (IV)` or `PEN (V)` accessories with **Dawn's Aura** (purchased for 5,000,000 Silver from NPC **Old Moon Manager**).

#### Sovereign Weapons

**Sovereign Weapons** represent the best-in-slot weapons. Crafting is performed by interacting with the **Bonghwang Statue** at **Mount Ahshi** in the **Land of the Morning Light: Seoul** region. Before crafting, any equipped **Garmoth's Heart** or **Karanda's Heart** must be extracted using a **Mirror of Equilibrium**.
...
The following pages provide additional utility and context for active players:

* **Server Status**: Refer to the [Server Status](https://moonbd.online/status) page for real-time uptime details.
* **Boss Spawns**: Access the [Boss Calendar](https://moonbd.online/boss-calendar) page to track boss spawn schedules.
* **Active Boosts**: View the [Timers](https://moonbd.online/timers) page to monitor active server-wide events and experience boosts.
* **Troubleshooting**: If experiencing technical issues, refer to the [Common Issues](https://moonbd.online/common-issues) page.
